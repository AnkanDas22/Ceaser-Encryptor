...
def decrypt():
    ...
    print('Your decrytped message is: ', newMessage)
    output.delete(0.0,END)
    output.insert(INSERT,newMessage)
...
Label (window, text="Enter the key for encryption(1-24):", bg="white", fg="black", font="none 12 bold") .grid(row=2, column=0, sticky=W)
